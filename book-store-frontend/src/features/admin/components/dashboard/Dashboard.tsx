...
import {
  ...
  SalesDataPoint,
} from "@/features/admin/dtos/response/dashboard-response.dto";
...
import { getStatsAction, getSalesOverTimeAction } from "../../actions/dashboard.actions";
...
export function Dashboard() {
  ...
  useEffect(() => {
    ...
    const fetchSalesOverTime = async () => {
      ...
      try {
        const response = await getSalesOverTimeAction();
        if (response.success && response.data) {
        ...
        <Card>
          ...
          <CardContent>
            {isLoadingStats ? (
              ...
              <div className="text-2xl">{statsData?.totalOrders ?? 0}</div>
            )}
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            {isLoadingStats ? (
              ...
              <div className="text-2xl">{statsData?.totalProducts ?? 0}</div>
            )}
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            {isLoadingStats ? (
              ...
              <div className="text-2xl">{statsData?.totalUsers ?? 0}</div>
            )}
          </CardContent>
        </Card>
      </div>
