...
const getItemsCount = async (): Promise<ServerResponseModel<number>> => {
...
const clearCart = async (): Promise<ServerResponseModel<CartResponse>> => {
...
export const cartService = { getCart, addItemToCart, removeItemFromCart, getItemsCount, clearCart };