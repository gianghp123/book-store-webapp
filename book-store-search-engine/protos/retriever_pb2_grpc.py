...
import protos.retriever_pb2 as retriever__pb2
...
class HybridBookRetrieverStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Retrieve = channel.unary_unary(
                '/protos.HybridBookRetriever/Retrieve',
...
class HybridBookRetrieverServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_HybridBookRetrieverServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'protos.HybridBookRetriever', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('protos.HybridBookRetriever', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class HybridBookRetriever(object):
    """Missing associated documentation comment in .proto file."""
